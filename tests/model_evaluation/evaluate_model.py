"""
Script para evaluar el modelo YOLOv11 entrenado con diferentes imágenes y videos
"""
...
class ModelEvaluator:
    def __init__(self, model_path):
        """
        Inicializar evaluador con modelo entrenado
    ...
    def evaluate_single_image(self, image_path, save_dir='tests/results'):
        """
        Evaluar modelo en una sola imagen
    ...
    def evaluate_video(self, video_path, save_dir='tests/results'):
        """
        Evaluar modelo en un video
        ...
        while cap.isOpened():
            ...
            # Detectar cada N frames para acelerar (por ejemplo, cada 5)
            if frame_count % 5 == 0:
